...
#include "meta_module/src/core/scene.gen.h"
...
#include "meta_module/src/renderer/texture_import.gen.h"
...
void InitTypes() {
    ...
    details::Reflection<sprint::Entity>::Allocate();
    details::Reflection<sprint::LinkComponent>::Allocate();
    ...
    details::Reflection<sprint::TextureImport>::Allocate();
    ...
    details::Reflection<sprint::Entity>::InitFields();
    details::Reflection<sprint::LinkComponent>::InitFields();
    ...
    details::Reflection<sprint::TextureImport>::InitFields();
}
